...
} from "./chunk-2UQNAP23.js";
import {
  RBush,
  VectorEventType_default,
  Vector_default,
  loadFeaturesXhr
} from "./chunk-SKDMOTRE.js";
import {
  Collection_default
} from "./chunk-PEAABDRV.js";
import "./chunk-ITAASIQU.js";
import {
  Projection_default,
  degreesToStringHDMS,
  equivalent,
...
import {
  ...
  registerFont
} from "./chunk-M3L73WIN.js";
import {
  ImageBase_default,
  ImageState_default
} from "./chunk-YALJV5IV.js";
import {
  createCanvasContext2D,
  releaseCanvas,
  toSize
} from "./chunk-UMBGVIAN.js";
import {
  SAFARI_BUG_237906
...
function createHitDetectionImageData(size, transforms, features, styleFunction, extent, resolution, rotation) {
  ...
  for (let i = 1; i <= featureCount; ++i) {
    ...
    const color2 = "#" + ("000000" + index.toString(16)).slice(-6);
...
function createPixelContext2() {
  ...
  canvas.width = 1;
  canvas.height = 1;
  pixelContext2 = canvas.getContext("2d");
}
...
var WebGLTileLayerRenderer = class extends Layer_default4 {
  ...
  renderFrame(frameState) {
    ...
    for (let i = 0, ii = tileTextures.length; i < ii; ++i) {
      ...
      if (tile instanceof Tile_default2 && tile.getState() === TileState_default.EMPTY) {
        continue;
      }
      const tileCoord = tile.tileCoord;
